...
class MCTSBase:
    ...
    def execute_move(self, state, a):
        ...
        :return: the new state from the next player's view and the game end indicator which takes 3 values: None-> game not end; 0 -> game ends with a tie; 1-> player who made the move win
        '''
        state[0, a[0], a[1]] = 1
